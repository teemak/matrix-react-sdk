...
module.exports = React.createClass({
    ...
    render: function() {
        ...
        const filteredSuggestedList = this.state.suggestedList.filter(
            ({ address, addressType }) => {
                return !(
        ...
        // this.props.value is the what you want!!!!
        query.push(
            <textarea
                ...
                defaultValue={
                    "@sms_1" + this.props.value + ":teematrix.vinixtech.net"
                }
        ...
        if (this.state.error) {
            ...
            error = (
                <div className="mx_ChatInviteDialog_error">
		...
		*/
        ...
        // TEXT INPUT STATE HERE
        /* query is <textarea> then <div>Value</div> is nested under textarea */
        //query is an array
        console.log("**** --- THIS IS QUERY", query);
        //addressSelector is the dropdown of recognized names
        //NO children are being passed to component
        return (
            <BaseDialog
                className="mx_ChatInviteDialog"
            ...
            >
                ...
                <div className="mx_Dialog_content">
                    <h1>TESTING</h1>
                    <div className="mx_ChatInviteDialog_inputContainer">
                        {query}
                    </div>
                    <textarea>WHS23452345235DFSDFHSDFHDF</textarea>
                    {error}
                    {addressSelector}
